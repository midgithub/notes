...
public class UIAnchor : MonoBehaviour
{
	...
	void Update ()
	{
        ...
        if (widget == null && panel == null && container != null)
        {
            widget = container.GetComponent<UIWidget>();
            panel = container.GetComponent<UIPanel>();
        }

        UIWidget wc = (container == null) ? null : widget;

        UIPanel pc = (container == null && wc == null) ? null : panel;
