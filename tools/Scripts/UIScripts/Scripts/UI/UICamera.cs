...
[Hotfix]
    ...
    //string m_touchEffectPrefabPath = "Effect/common/fx_dianji";
    //GameObject m_touchEffectObj = null;

    void showTouchEffect(Vector2 pos )
    {
	...
	public void ProcessTouch (bool pressed, bool unpressed)
	{
		...
		if (unpressed)
		{
            ...
            showTouchEffect(currentTouch.pos); 
