...
public class UIPopupList : UIWidgetContainer
{
	...
	void Highlight (UILabel lbl, bool instant)
	{
		if (mHighlight != null)
		{
            ...
            float offsetX = mHighlight.width*0.5f; //sp.borderLeft * scaleFactor;
			float offsetY = mHighlight.height*0.5f ;  //sp.borderTop * scaleFactor;

            Vector3 pos = lbl.cachedTransform.localPosition + new Vector3(-offsetX + lbl.width*0.5f, offsetY -lbl.height*0.5f, 1f);
