...
static public class NGUITools
{
	...
	static public void SetDirty (UnityEngine.Object obj)
	{
		...
		if (obj)
		{
			//if (obj is Component) LogMgr.UnityLog(NGUITools.GetHierarchy((obj as Component).gameObject), obj);
			//else if (obj is GameObject) LogMgr.UnityLog(NGUITools.GetHierarchy(obj as GameObject), obj);
			//else LogMgr.UnityLog("Hmm... " + obj.GetType(), obj);
    ...
    static public GameObject SetChild(GameObject parent, GameObject child)
    {
        GameObject go = child;
        if (go != null && parent != null)
        {
