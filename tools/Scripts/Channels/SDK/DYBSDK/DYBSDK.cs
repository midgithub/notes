...
[LuaCallCSharp]
[Hotfix]
public class DYBSDK: SDKChannel
{

    private static DYBSDK _instance = null;
    public static DYBSDK Instance
    {
        get
        {
            if (_instance == null)
                _instance = new DYBSDK();
...
#if UNITY_EDITOR
#elif UNITY_IOS  
        Debug.Log("DYBSDK :: pay : " + orderID + "  productID:" + productID);
