...
[AddComponentMenu("NGUI/Interaction/Wrap Content WithoutActive")]
[Hotfix]
public class UIWrapContentWithoutActive : MonoBehaviour
{
	/// <summary>
			...
			for (int i = 0; i < mChildren.size; ++i)
			{
				...
				if (cullContent)
				{
                    ...
                    //NGUITools.SetActive(t.gameObject, (distance > min && distance < max), false);
                    {
                        ...
                        t.transform.SetRenderActive(isShow);
                        t.gameObject.SendMessage(isShow ? "OnSetEnable" : "OnSetDisable",SendMessageOptions.DontRequireReceiver);
                    }
				}
			}
		}
