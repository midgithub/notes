...
[Hotfix]
public sealed class DefaultComparer_Out<T> : IEqualityComparer<T>
{
    ...
    public static DefaultComparer_Out<T> Instance
    {
        get
        {
            return s_Instance;
    ...
    private static DefaultComparer_Out<T> s_Instance = new DefaultComparer_Out<T>();
}
...
[Hotfix]
    ...
    private void Init(int capacity, IEqualityComparer<TKey> hcp)
    {
      ...
      this.hcp = (hcp != null) ? hcp : DefaultComparer_Out<TKey>.Instance;
        
      //this.hcp = (hcp != null) ? hcp : MyDictionary<TKey, int>.DefaultComparer<TKey>.Instance;
      if (capacity == 0)
    ...
    //[SecurityPermission(SecurityAction.LinkDemand, Flags = SecurityPermissionFlag.SerializationFormatter)]        //By XuXiang
