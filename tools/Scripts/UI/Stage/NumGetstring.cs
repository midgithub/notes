...
[Hotfix]
    public class NumGetString
    {
        ...
        private static String[] Ls_ShZ = { "零", "一", "二", "三", "四", "五", "六", "七", "八", "九", "十" };
        private static String[] Ls_DW_Zh = { "", "十", "百", "仟", "万", "拾", "佰", "仟", "亿", "拾", "佰", "仟", "万" };
        private static String[] Num_DW = { "", "拾", "佰", "仟", "万", "拾", "佰", "仟", "亿", "拾", "佰", "仟", "万" };
        ...
        public static String NumGetStr(Double Num)
        {
            ...
            {//整数部分处理
                ...
                if (NumStr_R.StartsWith("一十"))
                {
                    NumStr_R = NumStr_R.Substring(1);
                }
