...
[Hotfix]
        ...
        */
        ...
        private static Dictionary<string, AgentName_t> Names
        {
            get
            {
                if (ms_names == null)
...
[Hotfix]
        ...
        */
        ...
        public static void ExportNames(XmlWriter xmlWriter)
        {
            if (Names.Count > 0)
            {
				xmlWriter.WriteStartElement("instances");
                foreach (AgentName_t m in Names.Values)
                {
